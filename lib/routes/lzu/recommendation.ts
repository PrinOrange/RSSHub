...
const BASE_URL = 'https://www.lzu.edu.cn/index/tjgz.htm';
...
const handler: Route['handler'] = async () => {
    try {
        ...
        return {
            ...
            allowEmpty: true,
            language: 'zh-cn',
            feedLink: 'https://rsshub.app/lzu/recommendation',
            id: 'https://rsshub.app/lzu/recommendation',
        };
    } catch (error) {
