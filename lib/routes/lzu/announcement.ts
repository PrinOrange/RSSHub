...
const BASE_URL = 'https://www.lzu.edu.cn/index/tzgg.htm';
...
const handler: Route['handler'] = async () => {
    try {
        ...
        return {
            ...
            allowEmpty: true,
            language: 'zh-cn',
            feedLink: 'https://rsshub.app/lzu/announcement',
            id: 'https://rsshub.app/lzu/announcement',
        };
    } catch (error) {
