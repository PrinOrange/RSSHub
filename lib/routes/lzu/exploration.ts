...
const BASE_URL = 'https://www.lzu.edu.cn/index/kxts.htm';
...
const handler: Route['handler'] = async () => {
    try {
        ...
        return {
            ...
            allowEmpty: true,
            language: 'zh-cn',
            feedLink: 'https://rsshub.app/lzu/exploration',
            id: 'https://rsshub.app/lzu/exploration',
        };
    } catch (error) {
